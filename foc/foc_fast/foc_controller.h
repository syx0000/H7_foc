...
/*地址*/
#define MOTORID0_RUN_DATA_ADDRESS (FLASH_USER_COMMON_ADDR)         // 0x802d4000,4k
#define ERR_MESSGE_DATA_BASER (FLASH_USER_COMMON_ADDR + 0x1000)    // 0x802d5000,4k
#define TEST_LIMIT_DATA (FLASH_USER_COMMON_ADDR + 0x5000)          // 0x802d9000,4k
